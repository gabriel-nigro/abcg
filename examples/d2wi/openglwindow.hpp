...
class OpenGLWindow : public abcg::OpenGLWindow {
 ...
 private:
  ...
  std::array<glm::vec3, m_flyingAks> m_flyingAksPositions;
  std::array<glm::vec3, m_flyingAks> m_flyingAksRotations;
  float m_angle{};
  ...
  void randomizeFlyingAks(glm::vec3 &position, glm::vec3 &rotation);
